...
for epoch in range(epochs):
    ...
    def closure():
        ...
        print(
            ...
            f"Regularization loss: {loss_reg.item()}",
    ...
    with torch.no_grad():
            ...
            wandb.log(
                {
                    ...
                    "Validation Regularization loss": np.log10(
                        validation_loss_reg.item()
                    ),
        ...
        print(
            ...
            f"Validation Regularization loss: {validation_loss_reg.item()}",
